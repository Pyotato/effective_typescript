...
|  23  | [타입 넓히기](https://github.com/Pyotato/effective_typescript/blob/item23/README.md) | 💡 타입스크립트가 넗히기를 통해 상수의 타입을 추론하는 법을 이해해야 합니다. <br/>  💡 동작에 영향을 줄 수 있는 방법인 const, 타입 구문, 문맥, as const에 익숙해져야 합니다.                           |
